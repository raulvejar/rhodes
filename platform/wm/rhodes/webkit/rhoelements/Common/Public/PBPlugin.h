/**
 * \file PBPlugin.h
 * \brief File designed to be imported by PocketBrowser Plugins.  
 ...
 * to ensure conformance with the PocketBrowser architecture.
 */
class PBModule {
public:
	...
	*/
	 ...
	 * If registered for, PocketBrowser cannot switch to another application until this returns TRUE.
	 ...
	 *	@param	iImoID			PocketBrowser IMO ID.
	 ...
	 *	@param	iTabID			PocketBrowser application instance.
...
protected:	
	 ...
	 * Provides PocketBrowser with a way of invoking functionality in the module.
