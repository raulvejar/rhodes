...
/**
*	Sets PocketBrowser into Fullscreen/smallscreen
...
public:
	...
	BOOL	Init				(HINSTANCE hInstance,HWND hWndParent,PPBCORESTRUCT	pbCoreStruct,CWebKitEngine *pEngine,LPCTSTR pAppName,LPCTSTR PStartPage);
