...
#define GPSINFO_WAIT_TIMEOUT		3000		// Wait timeout
...
{
public:
	CGpsWrapper(IGpsWrapperObserver& observer);
	~CGpsWrapper(void);
	/**
...
public: //members
	static EngineLocation* s_pEkCachedPosition; //To be passed back to MotoWebKit
...
private: //members
	...
	unsigned short m_uTimeoutCount;
};
