...
//static	BOOL bRegistered = FALSE; // used to ensure that we only register the window class once
...
public:
	...
	*/
	...
	LPCTSTR				GetBadlink(LPCTSTR pCurrURL, bool bNavigationStopped = false);//appends the current URL to the badlink URL 
