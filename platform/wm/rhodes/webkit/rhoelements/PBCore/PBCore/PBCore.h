...
#ifndef __PB_CORE_H__
#define __PB_CORE_H__
...
* Global Functions
**********************************************************************************************/
//BOOL	Initialise		(LPTSTR lpCmdLine);///>return 0 if no error
...
*  orientation has been manually changed.  This enables PocketBrowser to resize
...
*  command line is assumed to apply to all running PocketBrowser applications.
...
struct stLog{
	...
	WCHAR	szLogComment[100];
	WCHAR	szFunctionName[MAX_URL + 1]; 
